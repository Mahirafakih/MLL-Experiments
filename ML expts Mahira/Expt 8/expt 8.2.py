...
master = Tk()
master.title("Mahira Fakih => 211P058 Customer Segmentation using Machine Learning")
Label(master, text="Mahira Fakih => 211P058 Customer Segmentation using Machine Learning", bg="Yellow", fg="black").grid(row=0, columnspan=2)
